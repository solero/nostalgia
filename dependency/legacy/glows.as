...
{ 
	...
	_local1.nameglow = _local2[25];
	_local1.namecolor = _local2[26] || 0;
	_local1.bubblecolor = _local2[27] || 0;
	_local1.bubbletext = _local2[28] || 0;
	_local1.ringcolor = _local2[29];
	_local1.obese = _local2[30];
	_local1.transparency = _local2[31];
	_local1.rotation = Number(_local2[32]) || 0;
	_local1.walls = Boolean(Number(_local2[33]) || 0);
	_local1.speed = Number(_local2[34]) || 0;
	_local1.mood = _local2[35];
	_local1.moodcolor = _local2[36] || 0;
	_local1.snowball = Number(_local2[37]) || 0;
